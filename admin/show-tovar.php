...
echo "<th><form action='change-tovar.php?idT=".$row['idT']."' method='post'><input class='button' type='submit' value='Изменить' name='changeT'></form></th>
	  <th><form action='show-tovar.php?idT=".$row['idT']."' method='post'><input class='button' type='submit' value='Удалить' name='delT'></form></th></tr>";
}
